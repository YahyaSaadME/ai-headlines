...
//     //     let res = String(output.output).split("**")
//     //     res.map(async (e, i) => {
//     //         try {
//     //             if (e.match(/\d+\./g)) {
//     //                 if (res[i + 1]) {
...
function all() {
    ...
    data.map((output, i) => {
        document.getElementById("inputs").innerHTML += `
                            <li onclick="open('-${i}')" class="text-white px-4 mt-4 flex justify-between items-center hover:text-gray-900 cursor-pointer hover:bg-white py-2 rounded-md border-2 border-gray-200 border-dashed">
